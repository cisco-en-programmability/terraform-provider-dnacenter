...
resource "dnacenter_wireless_accesspoint_configuration_create" "example" {
  provider = dnacenter
  parameters {
...
output "dnacenter_wireless_accesspoint_configuration_create_example" {
  value = dnacenter_wireless_accesspoint_configuration_create.example
}