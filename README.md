...
terraform {
  required_providers {
    dnacenter = {
      source = "hashicorp.com/edu/dnacenter"      version = "1.0.9-beta"    }
  }
}
...
In the [docs directory](./docs/) you can find the documentation source for this 1.0.9-beta version.
...
**NOTE**: Consider reviewing the Changelog to review the new features of the 1.0.9-beta version.
