...
page_title: "dnacenter_dhcp_services_count Data Source - terraform-provider-dnacenter"
subcategory: ""
description: |-
...
# dnacenter_dhcp_services_count (Data Source)
...
- `server_ip` (String) serverIp query parameter. IP Address of the DHCP Server. This parameter supports wildcard (***) character -based search. Example: *10.76.81.* or *56.78* or *50.2* Examples: serverIp=10.42.3.31 (single IP Address is requested) serverIp=10.42.3.31&serverIp=name2&fabricVnName=name3 (multiple IP Addresses are requested)
