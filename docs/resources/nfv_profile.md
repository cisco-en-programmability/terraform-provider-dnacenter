...
- `device_type` (String) Name of the device used in creating nfv profile
...
### Nested Schema for `parameters.device.custom_networks.services_to_connect`
...
- `device_type` (String) Type of the device(eg: Cisco 5400 Enterprise Network Compute System)
- `template` (String) Name of the template(eg NFVIS template)
- `template_type` (String) Name of the template type to which template is associated (eg: Cloud DayN Templates)
