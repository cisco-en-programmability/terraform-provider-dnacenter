...
page_title: "dnacenter_analytics_profiling_rules Resource - terraform-provider-dnacenter"
subcategory: ""
description: |-
...
# dnacenter_analytics_profiling_rules (Resource)
...
```terraform
resource "dnacenter_analytics_profiling_rules" "example" {
  provider = dnacenter
...
output "dnacenter_analytics_profiling_rules_example" {
  value = dnacenter_analytics_profiling_rules.example
}
```
...
```shell
terraform import dnacenter_analytics_profiling_rules.example "rule_id:=string"
```
