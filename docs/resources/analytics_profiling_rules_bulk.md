...
page_title: "dnacenter_analytics_profiling_rules_bulk Resource - terraform-provider-dnacenter"
subcategory: ""
description: |-
...
# dnacenter_analytics_profiling_rules_bulk (Resource)
...
```terraform
resource "dnacenter_analytics_profiling_rules_bulk" "example" {
  provider = meraki
  parameters {
...
output "dnacenter_analytics_profiling_rules_bulk_example" {
  value = dnacenter_analytics_profiling_rules_bulk.example
}
```
