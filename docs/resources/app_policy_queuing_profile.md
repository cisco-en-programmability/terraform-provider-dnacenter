...
- **parameters** (Block List, Min: 1, Max: 1) Array of RequestApplicationPolicyCreateApplicationPolicyQueuingProfile (see [below for nested schema](#nestedblock--parameters))
