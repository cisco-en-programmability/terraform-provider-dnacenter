...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			// "dnacenter_event_email_config":                      resourceEventEmailConfig(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"dnacenter_deploy_template":                                dataSourceDeployTemplate(),
			...
			"dnacenter_event_snmp_config":                              dataSourceEventSNMPConfig(),
